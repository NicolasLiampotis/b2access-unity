...
public class AuthenticationTopHeader extends TopHeaderLight
{
	...
	public AuthenticationTopHeader(String title, LocaleChoiceComponent localeChoice, UnityMessageSource msg)
	{
		super(title, msg);
                ...
                Link[] links = new Link[] {   
                    new Link("What is B2ACCESS", new ExternalResource("http://b2access.eudat.eu/b2access-about.html")),
                    new Link("User Guide", new ExternalResource("http://b2access.eudat.eu/b2access-guide.html")),
                    new Link("FAQs", new ExternalResource("http://b2access.eudat.eu/b2access-faq.html")),
